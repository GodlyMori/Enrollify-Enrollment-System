...
class StaffLoginScreen(QWidget):
    ...
    def setup_ui(self):
        ...
        subtitle = QLabel("Access the staff portal")
        ...
        self.email_input.setPlaceholderText("staff@enrollify.edu")
        ...
        # text
        demo_label = QLabel("Need assistance? Contact your Administrator")
